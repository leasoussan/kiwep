# Generated by Django 3.1.5 on 2021-05-05 09:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mission_type', models.CharField(choices=[('s_m', 'Individual Mission'), ('t_m', 'Collective Mission')], default='s_m', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual_missions', models.ManyToManyField(through='content.IndividualProjectMission', to='content.Mission')),
        ...
        migrations.AddField(
            model_name='project',
            name='missions',
            field=models.ManyToManyField(blank=True, through='content.ProjectMissionRating', to='content.Mission'),
        ),
        migrations.AddField(
            model_name='project',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='content.projectmissionrating'),
        ),
        migrations.AddField(
            model_name='hardskillsrating',
            name='skill',
